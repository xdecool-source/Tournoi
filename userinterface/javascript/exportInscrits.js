...
// credentials:"include" gestion admin password
    ...
    try{
        ...
        let statsHtml = `
            <div class="card"><p>Total inscrits <br></p>
                <h2 style="font-size:24px;color:#1976d2;">
                    ${inscrits.length}
                </h2><br><br>Répartition :</div>`;
        ...
        for(const t in tableauxConfig){
            ...
            let textePlaces = `
                <span style="font-size:20px;font-weight:bold;">
                    ${ok}/${capacite}
                </span><br><span style="font-size:12px;font-weight:normal;color:#666;">
            ...
            if(
                ...
                textePlaces = `
                    <span style="font-size:18px;font-weight:bold;color:#c62828;">
                        COMPLET
                    </span><br><span style="font-size:14px;font-weight:normal;color:#666;">
                        Attente pleine
                    </span>
                `;
                color = "#c62828";
        ...
        let html = `
            <table>
                <thead><tr><th>dossard</th><th>Licence</th><th>Nom</th>
                <th>Prénom</th><th>Club</th><th>Points</th><th>Tableaux</th></tr>
                </thead>
                <tbody>
        `;
        // Lignes joueurs
        ...
        for(const p of inscrits){
            ...
            const badgeAnnule =
                ...
                p.annule === "true"
                    ? `
                        <span style="background:#c62828;color:white;padding:4px 8px;border-radius:6px;
